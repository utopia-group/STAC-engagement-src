...
import net.techpoint.note.event.EventRecodingLogger;
...
implements Logger {
    ...
    Logger delegate() {
        return this._delegate != null ? this._delegate : this.fetchEventRecordingLogger();
    }

    private Logger fetchEventRecordingLogger() {
    ...
    public void log(LoggingEvent event) {
        if (this.isDelegateEventAware()) {
            this.logSupervisor(event);
        }
    }

    private void logSupervisor(LoggingEvent event) {
        try {
