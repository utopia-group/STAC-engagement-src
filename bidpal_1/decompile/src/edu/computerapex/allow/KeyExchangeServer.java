...
import edu.computerapex.math.CircularExponentiation;
...
public class KeyExchangeServer {
    ...
    public BigInteger pullFloormod() {
        return this.floormod;
    }

    public BigInteger fetchGenerator() {
    ...
    public BigInteger generateMasterSecret(BigInteger clientPublic) {
        return CircularExponentiation.circularExponentiation(clientPublic, this.secretKey, this.floormod);
    }
