...
implements Logger {
    ...
    private void recordEvent(Level level, Marker marker, String msg, Object[] args, Throwable throwable) {
        ...
        loggingEvent.assignTimeStamp(System.currentTimeMillis());
        loggingEvent.defineLevel(level);
        loggingEvent.assignLogger(this.logger);
        loggingEvent.fixLoggerName(this.name);
        loggingEvent.fixMessage(msg);
        loggingEvent.assignArgumentArray(args);
        loggingEvent.defineThrowable(throwable);
